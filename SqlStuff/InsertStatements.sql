...
--Timeoff Table
INSERT ALL
    INTO TIMEOFF (empNum, startDate, endDate, totalHours, typeHoursUsed, submitted) VALUES (234567891, (TO_DATE('02-JAN-2020', 'DD-MM-YYYY')), (TO_DATE('04-JAN-2020','DD-MM-YYYY')), 24, 'AL', (TO_DATE('02-DEC-2020', 'DD-MM-YYYY')))
    INTO TIMEOFF (empNum, startDate, endDate, totalHours, typeHoursUsed, submitted) VALUES (1659042142199, (TO_DATE('08-FEB-2020', 'DD-MM-YYYY')), (TO_DATE('09-FEB-2020','DD-MM-YYYY')), 16, 'BANKED HOLIDAY', (TO_DATE('08-JAN-2020', 'DD-MM-YYYY')))
    INTO TIMEOFF (empNum, startDate, endDate, totalHours, typeHoursUsed, submitted) VALUES (1637071368899, (TO_DATE('10-JAN-2020', 'DD-MM-YYYY')), (TO_DATE('15-JAN-2020','DD-MM-YYYY')), 48, 'AL', (TO_DATE('10-DEC-2020', 'DD-MM-YYYY')))
    INTO TIMEOFF (empNum, startDate, endDate, totalHours, typeHoursUsed, submitted) VALUES (1652052669599, (TO_DATE('02-JAN-2020', 'DD-MM-YYYY')), (TO_DATE('02-JAN-2020','DD-MM-YYYY')), 8, 'AL', (TO_DATE('03-DEC-2020', 'DD-MM-YYYY')))
    INTO TIMEOFF (empNum, startDate, endDate, totalHours, typeHoursUsed, submitted) VALUES (1628030773999, (TO_DATE('01-JAN-2020', 'DD-MM-YYYY')), (TO_DATE('03-JAN-2020','DD-MM-YYYY')), 24, 'AL', (TO_DATE('15-DEC-2020', 'DD-MM-YYYY')))
    INTO TIMEOFF (empNum, startDate, endDate, totalHours, typeHoursUsed, submitted) VALUES (1652052669599, (TO_DATE('05-FEB-2020', 'DD-MM-YYYY')), (TO_DATE('06-FEB-2020','DD-MM-YYYY')), 24, 'FLOATING HOLIDAY', (TO_DATE('10-JAN-2020', 'DD-MM-YYYY')))
    INTO TIMEOFF (empNum, startDate, endDate, totalHours, typeHoursUsed, submitted) VALUES (1631060769399, (TO_DATE('15-MAR-2020', 'DD-MM-YYYY')), (TO_DATE('28-MAR-2020','DD-MM-YYYY')), 80, 'PLANNED MEDICAL', (TO_DATE('11-MAR-2020', 'DD-MM-YYYY')))
    INTO TIMEOFF (empNum, startDate, endDate, totalHours, typeHoursUsed, submitted) VALUES (1699092461899, (TO_DATE('29-JAN-2020', 'DD-MM-YYYY')), (TO_DATE('02-FEB-2020','DD-MM-YYYY')), 40, 'AL', (TO_DATE('15-JAN-2020', 'DD-MM-YYYY')))
    INTO TIMEOFF (empNum, startDate, endDate, totalHours, typeHoursUsed, submitted) VALUES (1656060781399, (TO_DATE('02-FEB-2020', 'DD-MM-YYYY')), (TO_DATE('03-FEB-2020','DD-MM-YYYY')), 16, 'AL', (TO_DATE('02-DEC-2020', 'DD-MM-YYYY')))
    INTO TIMEOFF (empNum, startDate, endDate, totalHours, typeHoursUsed, submitted) VALUES (1635040400999, (TO_DATE('13-FEB-2020', 'DD-MM-YYYY')), (TO_DATE('15-FEB-2020','DD-MM-YYYY')), 24, 'AL', (TO_DATE('28-JAN-2020', 'DD-MM-YYYY')))
SELECT * FROM dual;